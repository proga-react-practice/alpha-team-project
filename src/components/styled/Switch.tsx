...
export const MaterialUISwitch = styled(Switch)(({ theme }) => ({
  ...
  "& .MuiSwitch-switchBase": {
    ...
    "&.Mui-checked": {
      ...
      "& + .MuiSwitch-track": {
        opacity: 1,
        backgroundColor: theme.palette.mode === "dark" ? "#060a52" : "#1ca06f",
      },
    },
  },
  "& .MuiSwitch-thumb": {
    backgroundColor: theme.palette.mode === "dark" ? "#353eef" : "#23cb8d",
    width: 52,
    height: 52,
    "&::before": {
      content: "''",
  ...
  "& .MuiSwitch-track": {
    opacity: 1,
    backgroundColor: theme.palette.mode === "dark" ? "#060a52" : "#b7f3dd",
    borderRadius: 30,
  },
}));
